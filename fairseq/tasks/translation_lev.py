...
INIT_OUTPUT_CHOICES = ChoiceEnum(['blank','target','source'])
...
class TranslationLevenshteinConfig(TranslationConfig):
    ...
    init_output: INIT_OUTPUT_CHOICES = field(
        default="blank",
        metadata={
            "help": "type of init_output"
        },
    )
...
class TranslationLevenshteinTask(TranslationTask):
    ...
    def build_generator(self, models, args, **unused):
        ...
        init_tokens = None if self.cfg.init_output == 'blank' else self.cfg.init_output
